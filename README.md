...
[![ESPHome](https://img.shields.io/badge/ESPHome-2026.4.2-blue)](https://esphome.io)
...
- ✅ **Extra :**
  - Each wake word with his own sensibility change and each of them with 11 preset (all customizable, wake word's, sensibility preset's, name's ...)
  - Better voice capture for longer distance: improvements works with wake word and spoken word's 
